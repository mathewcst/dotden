          ...
          <div className="flex max-w-xl flex-col gap-6">
            ...
            <ol className="text-muted-foreground grid gap-3 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  On your next computer, <span className="text-foreground font-medium">Apply</span>{' '}
                  them — your setup, everywhere.
                </span>
              </li>
            </ol>
            <div>
          ...
          <div className="flex max-w-xl flex-col gap-6">
            <header className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <span className="text-foreground font-medium">empty private repo</span> now; you’ll
                paste its URL next.
              </p>
            </header>
        ...
        {step === 'done' ? (
          <div className="flex max-w-xl flex-col gap-6">
            ...
            <ul className="text-muted-foreground grid gap-2 text-sm">
              ...
              {autoSync ? (
                <li className="flex items-center gap-2">
                  <Check className="text-dd-green-400 size-4" /> Auto-sync is on — Committed changes
                  send automatically.
                </li>
              ) : null}
            </ul>
