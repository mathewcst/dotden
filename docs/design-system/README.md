...
| Sync states             | [screens/sync-states.md](./screens/sync-states.md)                     | Syncing / Up to date / N incoming / N ahead to push — the `Banner` strip inserted into `AppShell` + titlebar/inspector overrides                                                                                                                                                                 |
