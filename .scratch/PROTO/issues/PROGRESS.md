...
- `1-06` — [issue-06-discovery-onboarding.md](./issue-06-discovery-onboarding.md) _(unblocked by 1-04)_
...
| `1-06` | Tool-catalog discovery scan + first-environment onboarding | AFK | 1-04 | ⬜ Not started | | | | | |
